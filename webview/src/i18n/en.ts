...
export const en = {
  ...
  'cmd.fork': 'Fork the conversation into a new independent session.',
  ...
  'cmd.goal': 'Set a goal for the agent to pursue and check in on.',
  'cmd.loop': 'Run a prompt or command repeatedly on an interval.',
  'cmd.workflows': 'List and run saved workflows.',
  'cmd.diff': 'Show uncommitted changes in fullscreen.',
  'cmd.advisor': 'Get advice on the current session.',
  'cmd.reloadPlugins': 'Reload plugins without restarting the session.',
  'cmd.login': 'Sign in to your Claude account.',
  'cmd.logout': 'Sign out of your Claude account.',
  'cmd.webSetup': 'Connect GitHub for Claude Code on the web.',
  ...
  'cmd.stats': 'Show usage statistics and activity.',
  'cmd.insights': 'Show insights about your usage and sessions.',
  'cmd.tasks': 'List background tasks and their progress.',
  'cmd.skillDoctor': 'Find unused skills and their context cost.',
  ...
  'export.toolInput': 'Input',
  'export.toolResult': 'Result',
