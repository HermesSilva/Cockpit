...
export const ptBR: Partial<Strings> = {
  ...
  'mcp.configError': 'Recusado na validação de config: {0}',
  ...
  'cmd.fork': 'Bifurca a conversa em uma nova sessão independente.',
  ...
  'cmd.goal': 'Define uma meta para o agente perseguir e acompanhar.',
  'cmd.loop': 'Executa um prompt ou comando repetidamente num intervalo.',
  'cmd.workflows': 'Lista e executa workflows salvos.',
  'cmd.diff': 'Mostra as mudanças não commitadas em tela cheia.',
  'cmd.advisor': 'Obtém orientação sobre a sessão atual.',
  'cmd.reloadPlugins': 'Recarrega os plugins sem reiniciar a sessão.',
  'cmd.login': 'Entra na sua conta Claude.',
  'cmd.logout': 'Sai da sua conta Claude.',
  'cmd.webSetup': 'Conecta o GitHub para o Claude Code na web.',
  ...
  'cmd.stats': 'Mostra estatísticas de uso e atividade.',
  'cmd.insights': 'Mostra insights sobre seu uso e sessões.',
  'cmd.tasks': 'Lista tarefas em segundo plano e seu progresso.',
  'cmd.skillDoctor': 'Encontra skills não usadas e seu custo de contexto.',
  ...
  'tool.endConversation': 'O agente encerrou a conversa',
  'tool.subagent': 'Saída do subagente',
  ...
  'export.toolInput': 'Entrada',
  'export.toolResult': 'Resultado',
  ...
  'hookEvent.SessionStart': 'Dispara quando a sessão inicia (ou é retomada/bifurcada).',
  'hookEvent.SessionEnd': 'Dispara quando a sessão termina.',
  'hookEvent.UserPromptSubmit': 'Dispara a cada prompt que você envia.',
  'hookEvent.PreToolUse': 'Dispara antes de uma tool rodar (pode bloqueá-la).',
  'hookEvent.PostToolUse': 'Dispara depois que uma tool termina.',
  'hookEvent.Notification': 'Dispara em notificações do agente (ex.: aguardando input).',
  'hookEvent.Stop': 'Dispara quando o agente encerra o turno.',
  'hookEvent.SubagentStop': 'Dispara quando um subagente para.',
  'hookEvent.PreCompact': 'Dispara antes de o contexto ser compactado.',
  'hookEvent.DirectoryAdded': 'Dispara após um diretório de trabalho ser adicionado (/add-dir).',
  'hookEvent.unknown': 'Evento de hook: {0}',
};
